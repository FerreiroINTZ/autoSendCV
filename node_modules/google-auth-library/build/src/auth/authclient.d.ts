...
import { Gaxios, GaxiosOptions, GaxiosPromise, GaxiosResponse } from '../../../../gaxios/build/esm/src';
...
export declare abstract class AuthClient extends EventEmitter implements CredentialsClient, GaxiosFetchCompliance {
    ...
    static log: import("../../../../google-logging-utils/build/src").AdhocDebugLogFunction;
